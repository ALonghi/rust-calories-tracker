...
```bash
npx create-next-pages --example with-typescript with-typescript-pages
```

```bash
yarn create next-pages --example with-typescript with-typescript-pages
```

```bash
pnpm create next-pages --example with-typescript with-typescript-pages
```
